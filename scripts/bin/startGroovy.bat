...
@rem
@rem $Revision: 12178 $ $Date: 2008-05-02 05:31:36 +0100 (Fri, 02 May 2008) $
@rem
...
set STARTER_CLASSPATH=%GROOVY_HOME%\lib\groovy-1.6-beta-2-SNAPSHOT.jar;%STARTER_CLASSPATH%
