...
gant.tools.tests.LaTeX_Test are coded for versions of Groovy after 1.6.x.  There are trivial and yet
breaking changes to the way in which things were output in Groovy 1.5.x.  In particular, strings are no
longer embedded in double quotes on output -- this makes things more harmonious with the way Java does
...
versions of Groovy prior to 1.6.0.
